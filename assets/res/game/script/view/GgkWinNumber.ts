...
export class GgkWinNumber {
  ...
  public init(gameView: UI_GgkView): void {
    ...
    EventManager.on(GameEvent.OPEN_WIN_NUMBER, this.onOpenWinNumber, this);
    EventManager.on(GameEvent.RESET_GAME, this.onResetGame, this);
    //EventManager.on(GameEvent.CARD_SHUFFLE_COMPLETE, this.onCardShuffleComplete, this);
  ...
  private onWinNumOpen(): void {
    EventManager.emit(GameEvent.OPEN_LOTTORY);
  }
